...
\begin{definition}{光锥动量}{}%%\ref{def:label}
    ...
    \begin{equation}\begin{aligned}
            %%\label{eq.6.1.2}
            D_\phi(k)   & {}=
            k^2 - {m_\phi}^2+i \epsilon
            =k^+ k^- - k_\perp^2 - {m_\phi}^2 +i \epsilon
            ={\color{main}k^+ k^- - \Omega_\phi + i \epsilon},                     \\
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            D_B(p-k)    & {}=
            (p-k)^2 - {m_B}^2 + i \epsilon
            =(p-k)^+ (p-k)^- - k_\perp^2 - {m_B}^2 + i \epsilon                    \\
                        & {}={\color{main}(p-k)^+ (p-k)^- - \Omega_B + i \epsilon} \\
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            \Omega_\phi & {}=
            k_\perp^2 + {m_\phi}^2 \geq 0                                          \\
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            \Omega_B    & {}=
            k_\perp^2 + {m_B}^2 \geq 0                                             \\
        \end{aligned}\end{equation}
\end{definition}
...
\begin{definition}{光锥动量}{}%%\ref{def:label}
    ...
    \begin{equation}\begin{aligned}
            %%\label{eq.6.1.2}
            \int d k^- \frac{1}{D_\phi D_B} & {}= \frac{- 2 \pi i }
            { D_{\phi B} p^+ \bar{y} }                                                                               \\
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        -\left(
        \frac{
                k_\perp^2 + y M_B^2+(1-y)m_\phi^2-y(1-y)M^2
            }
            {1-y}
        \right)                                                                              \\
        \bar{y}&{}=1-y \\
...
作为一个例子，演示第一个积分的计算过程，
单极点位于$k^- \to \frac{\Omega_\phi - i \epsilon}{k^+}$ and 
$k^- \to p^- -\left(\frac{\Omega_B - i \epsilon}{p^+ - k^+}\right)$
第一个极点位于下半平面，第二个极点位于上半平面。
第一个极点的表达式更简单一些。
根据留数定理：
...
\begin{equation}\begin{aligned}
        ...
        = -2 \pi i~\res \left[\frac{1}{D_\phi D_B}\right]_{\mathrm{lower~half~plane}} \\
         ...
         & {}=\frac{ 2 \pi i}
        {
            p^+
            \left[
                k_\perp^2+(1-y)m_\phi^2+
                y^2 M_B^2
                \right]
        }                                                                                    \\
         & {}= \frac{-2\pi i }{ D_{\phi B} p^+ \bar{y} }                                     \\
        D_{\phi B}
         & {}=
        -\left(
        \frac{
            ...
            {1-y}
        \right)                                                                              \\
        & \text{if set } M=M_B, \text{ then }
        D_{\phi B} =
        -\left(
        \frac{
            k_\perp^2+(1-y)m_\phi^2+ y^2 M_B^2
            }{1-y}
        \right) \\
        %%%%%+++++++++++++++++++++++
    \end{aligned}\end{equation}
...
以第一个为例，
    ...
    \begin{equation}\begin{aligned}
        ...
        %%%%%+++++++++++++++++++++++---------------------
        &{} \int d k^- \frac{1}{D_\phi} 
       =\frac{1}{\left(k^+ k^- -\Omega_\phi+ i \epsilon\right)}  \\
        %%%%%+++++++++++++++++++++++
    \end{aligned}\end{equation}