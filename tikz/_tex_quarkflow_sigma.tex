...
\begin{tikzpicture}
	\begin{feynman}
		...
		%费米子箭头连线
		{ [edge= fermion]
		(x1) --[edge label =\(\Sigma^{+}\)](x2)--[edge label =\(\Xi^{0}\)](x4) --[edge label =\(\Sigma^{+}\)](x5),
		%%%
		...
		%%%
		(y1) --[edge label =\(\Sigma^{+}\)](y2)--[edge label =\(p\)](y4) --[edge label =\(\Sigma^{+}\)](y5),
		%%%
		(c5)--(c6),(c7)--(c8),
		(c2) --[half left,looseness=1.5,edge label =\(s\)](c3),
		(c9) --[half right,looseness=0.9,edge label =\(d\)](c10) --[half right,looseness=0.9](c9),
		},
		% 介子连线
		{ [edge= charged scalar]
		(x2) --[half left,edge label =\(K^{+}\)](x4),
		(y2) --[half left,edge label =\(\overline{K^{0}}\)](y4),
		}
		};
	\end{feynman}
\end{tikzpicture}
