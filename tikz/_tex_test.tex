...
\begin{tikzpicture}
	...
	\draw [decorate,decoration=snake,fill=blue!10!white]   (1,0)  arc (0:360:1 and 1)  (-0.5,0.1)node[] {$\rho(\vec{r})$} ;
	\draw[ draw=red!0!black,thick,-{Latex[length=3mm ]}] (-2,-3)--(0,0);
	\draw[ draw=red!80!black,thick,-{Latex[length=3mm ]}] (0,0)--(5,1);
	\draw[ draw=red!0!black,thick,-{Latex[length=3mm ]}] (-2,-3)--(5,1);
    % text
    \node at (-2.1,-3.1) {\large $o$};
    \node at ($(-2,-3)!0.5!15 :(0,0)$) {\large $\vec{r^{\prime}}$};
    \node at ($(0,0)!0.5! 6 :(5,1)$) {\large $\vec{r}-\vec{r^{\prime}}$};
    \node at ($(-2,-3)!0.5! -5 :(5,1)$) {\large $\vec{r}$};
\end{tikzpicture}
